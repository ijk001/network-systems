...
\- Network is segmented across different branches of an organization located in different cities or regions
...
\- Network is divided into separate segments for HR, Finance, and IT departments within an organization
...
→ Create multiple smaller, controlled network segments
