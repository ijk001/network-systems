...
👉 Devices in the same VLAN can be located on different switches, but still belong to the same logical network.
...
![VLANs and Subnets connected through a single router interface](image-2.png)
